...
Built in Java using [JDA](https://github.com/DV8FromTheWorld/JDA) as a Gradle project.
...
Use the server template: https://discord.new/qjjWS4zBUF2a

You'll need to add DemocracyBot and hoist its generated bot role to the top.
